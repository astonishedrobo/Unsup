...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_data_path', default='/home/soumyajit/DPT/DPT_Data_Train/images')
    parser.add_argument('--train_label_path', default='/home/soumyajit/DPT/DPT_Data_Train/annotations')
    ...
    parser.add_argument('--save_path',default='/home/soumyajit/DPT/model_epoch_160.pth')
    parser.add_argument('--loss_log_dir',default='/home/soumyajit/DPT/log_directory/adam_and_lr1e-5')
