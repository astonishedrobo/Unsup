...
class HourGlass(nn.Module):
    def __init__(self,depth_est=True, color_seg=False, num_classes = 255):
        super(HourGlass, self).__init__()
        self.depth_est =depth_est
        self.color_seg = color_seg
        ...
        self.J = nn.Conv2d(64, num_classes, 3, padding=1)
    ...
    def forward(self, x):
        ...
        if self.depth_est and self.color_seg:
            return self.I(channel_1), self.J(channel_1)  # (1, 240, 320)
        elif self.depth_est:
            return self.I(channel_1)
        elif self.color_seg:
            return self.J(channel_1)
